...
# Read CSV
df = pd.read_csv("C:/Users/goggi/Downloads/CelebA/list_attr_celeba.csv")
# df = df.head(21)
...
# Saving into csv
pd.DataFrame(data=new_dict).to_csv("C:/Users/goggi/Downloads/CelebA/text_shuffle_descr_celeba.csv", index=False)
